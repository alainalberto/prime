...
urlpatterns = [
    ...
    url(r'^permit/create/(?P<pk>\d+)/$', login_required(permission_required('services.add_permit')(PermitCreate.as_view())), name='permit_create'),
    ...
    url(r'^folder/create/(?P<pk>\d+)/$', login_required(permission_required('tools.add_file')(FolderCreate.as_view())), name='folder_create'),
    ...
    url(r'^equipment/create/(?P<pk>\d+)/$', login_required(permission_required('services.add_equipment')(EquipmentCreate.as_view())), name='equipment_create'),
    url(r'^equipment/edit/(?P<pk>\d+)/$', login_required(permission_required('services.change_equipment')(EquipmentEdit.as_view())), name='equipment_edit'),
    url(r'^equipment/(?P<pk>\d+)/$', login_required(permission_required('services.delete_equipment')(EquipmentDelete.as_view())), name='equipment_delete'),
    ...
    url(r'^insurance/create/(?P<pk>\d+)/$', login_required(permission_required('services.add_insurance')(InsuranceCreate.as_view())), name='insurance_create'),
    ...
    url(r'^driver/create/(?P<pk>\d+)/$', login_required(permission_required('services.add_driver')(DriverCreate.as_view())),name='driver_create'),
    ...
    url(r'^ifta/create/(?P<pk>\d+)/$', login_required(permission_required('services.add_ifta')(IftaCreate.as_view())), name='ifta_create'),
    ...
    url(r'^audit/create/(?P<pk>\d+)/$', login_required(permission_required('services.add_audit')(AuditCreate.as_view())),name='audit_create'),
    ...
    url(r'^contract/create/(?P<pk>\d+)/$', login_required(permission_required('services.add_contract')(ContractCreate.as_view())),name='contract_create'),

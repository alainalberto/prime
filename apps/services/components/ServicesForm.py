...
class FileForm(forms.ModelForm):
    class Meta:
        ...
        widgets = {
            ...
            'category': forms.Select(attrs={'class': 'form-control input-md'}, choices=(('', '---------'),('Company', 'Company'),('Accidents', 'Accidents'), ('COI', 'COI'),('Insurance', 'Insurance'), ('Endorsments', 'Endorsements'), ('Misselenious', 'Miscellameous'), ('Permit', 'Permit'), ('Quote', 'Quote'), ('Audit', 'Audit'), ('Contract', 'Contract'), ('Accounting', 'Accounting'), ('ID_Card', 'ID Card'), ('Binders_Confirmation', 'Binders & Confirmation'), ('Bor', 'Bor'), ('Client_Proposals', 'Client Proposals'), ('Correspondece', 'Correspondece'), ('Exposure_Data_Marketing', 'Exposure Data & Marketing'), ('Licenses_Permits', 'Licenses & Permits'), ('Policies', 'Policies'))),
            'url': forms.FileInput(),
        }
